...
This code is only meant to make easier the process of creating the masks for the 
different colors we want to detect. It is not meant to be used in the final program.
"""
